...
class TrashScreen extends StatelessWidget {
        ...
        actions: [
          if (deletedNotes.isNotEmpty)
            TextButton(
              ...
              child: Text(AppStrings.emptyTrash, style: const TextStyle(color: AppColors.danger)),
            ),
        ],
      ),
  ...
  void _showEmptyTrashDialog(BuildContext context, NoteProvider provider) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text(AppStrings.emptyTrashTitle),
        content: Text(AppStrings.emptyTrashConfirm),
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx), child: Text(AppStrings.cancel)),
          ElevatedButton(
            onPressed: () {
            ...
            child: Text(AppStrings.emptyTrash, style: const TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
