            ...
            children: [
              ...
              if (provider.profilePictureBase64 != null)
                TextButton(
                  ...
                  child: const Text(AppStrings.removePhoto, style: TextStyle(color: AppColors.danger)),
                ),
                  ...
                  onPressed: () {
                    if (provider.backupEmail == null || provider.backupEmail!.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text(AppStrings.enterEmailFirst)),
                      );
                    } else {
                      provider.syncToEmail();
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text(AppStrings.syncStarting)),
                      );
                    }
                  },
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () => launchUrl(Uri.parse('https://github.com/faruk-guler'), mode: LaunchMode.externalApplication),
                      child: Text(
                        'github.com/faruk-guler',
                        style: TextStyle(
                          color: theme.primaryColor.withValues(alpha: 0.7),
                          fontSize: 13,
                          decoration: TextDecoration.underline,
